...
class SampleTexts : ASDisplayNode {
    ...
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        return ASStackLayoutSpec.vStackSpec {
            ...
            tell(ReTextNode("Welcome to ReNode by SeriousMD")) {
                $0.setClickableLinks([
                    .init(substring: "ReNode", urlPath: "https://gitlab.com/leapfroggr/ReNode"),
                    .init(substring: "SeriousMD", urlPath: "https://seriousmd.com")
                ])
            }
            
            tell(ReSubtitle()) {
                $0.set(strings: ["one", "two", "three"])
            }
        }
